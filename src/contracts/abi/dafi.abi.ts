...
export const DafiAbi: AbiItem | AbiItem[] = [
  {
    inputs: [
      ...
      { internalType: "contract IToken", name: "_dBTC", type: "address" },
      {
        internalType: "contract IoffTokens",
        name: "dBTCmain",
        type: "address",
      },
      { internalType: "contract IToken", name: "_dETH", type: "address" },
      {
        internalType: "contract IoffTokens",
        name: "dETHmain",
        type: "address",
      },
      { internalType: "contract IToken", name: "_dLINK", type: "address" },
      {
        internalType: "contract IoffTokens",
        name: "dLINKmain",
        type: "address",
      },
      { internalType: "contract IToken", name: "_dSNX", type: "address" },
      {
        internalType: "contract IoffTokens",
        name: "dSNXmain",
        type: "address",
